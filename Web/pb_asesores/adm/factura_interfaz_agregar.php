...
<div class="panel panel-primary">
  <div class="panel-heading">
    <h2 class="panel-title"><span align="right" class="glyphicon glyphicon-plus-sign"></span><b>&nbsp;&nbsp;NUEVA FACTURA</b></h2>
  </div>
  <div class="panel-body">
    <div class="container">
                        ...
                        <div class="form-group">
                                ...
                                <input value="" type="hidden" maxlength="15" class="frm form-control" name="idcli" id="idcli" placeholder="" />
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
	                               <input type="date" class="frm form-control" name="fecha" id="fecha" placeholder="" />
						         </div>


                                <label for="codigo" class="col-sm-1 control-label">Número:</label>
                                <div class="col-sm-2">
                                <input type="text" maxlength="100" class="frm form-control" name="nr" id="nr" placeholder="" />
                                ...
                                <div class="col-sm-2">
                                <input type="text" maxlength="40" class="frm form-control" name="cedrif" id="cedrif" placeholder="" />
                            ...
                            <label class="col-sm-2 control-label">Nombre/Razón Social:</label>
                                <div class="col-sm-2">
                                <input type="text" maxlength="60" class="frm form-control" name="nomrs" id="nomrs" placeholder="" />
                                    
                                </div>

                            <label for="monto" class="col-sm-1 control-label">Monto:</label>
                                <div class="col-sm-2">
                                <input type="text" maxlength="40" class="frm form-control" name="monto" id="monto" placeholder="" />
                            ...
                            <input hidden class="frm" name="idf" id="idf" value="" />
