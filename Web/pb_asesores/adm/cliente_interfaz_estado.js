jQuery(document).ready(function(){
	...
	jQuery("#cedrif").blur(function(){
		 if($("#tp").val()=='V'){
					 if($("#cedrif").val()>80000000){
					   swal({ title: "Error",   
									text: "Las cédulas venezolanas no pueden exceder de 80 millones",   
									type: "warning",   
				 ...
				 if($("#tp").val()=='E'){
					 if($("#cedrif").val()<80000000){
					   swal({ title: "Error",   
									text: "Las cédulas extranjeras no pueden ser menores de 80 millones",   
									type: "warning",   
									showCancelButton: false,   
									confirmButtonColor: "#BBD7ED",   
									confirmButtonText: "Aceptar",   
