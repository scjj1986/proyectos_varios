...
<script type='text/javascript' language='javascript' src='js/reporteEstadisticas.js'></script>
<?php
  ...
  <div class="panel-body">
    <div class="container">
                        <form role="form" class="frmpss form-horizontal">               
                                ...
                                <div class="col-sm-2">
                                <input type="text" class="form-control" id="datepicker" placeholder="" required onkeyup="mascara(this,'',patron,true)">
                                </div>
