 ...
 * @author salazar
 */
public class NuevoCarrera extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(PanelVentana, javax.swing.GroupLayout.DEFAULT_SIZE, 385, Short.MAX_VALUE)
        );
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        String consulta="select * from carrera where nombre='"+txtNombre.getText().toUpperCase()+"'";
        if (txtNombre.getText().equals("")) {
            ...
            Mensaje.showMessageDialog(this,"Carrera repetida. Intente de nuevo.","Error",Mensaje.ERROR_MESSAGE);
        }
        else{
            consulta="INSERT into carrera (nombre) values('"+txtNombre.getText().toUpperCase()+"')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoCarrera().setVisible(true);
            }
        });
    }
