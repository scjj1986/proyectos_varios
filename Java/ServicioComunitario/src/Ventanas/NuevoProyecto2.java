...
public class NuevoProyecto2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jScrollPane5.setPreferredSize(new java.awt.Dimension(600, 1550));
        ...
        cmbTipoProyecto.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione...", "UNEFA va a la escuela", "UNEFA va a la comunidad", "UNEFA va a los centros penitenciarios", "Enmarcado al programa TODAS LAS MANOS A LA SIEMBRA" }));
        ...
        cmbCedTut.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "V-", "E-" }));
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        txtCedulaP.setEnabled(true);
        String consulta="select * from proyecto where nombre='"+txtNombre.getText().toUpperCase()+"'";
        if ( (cmbCuo.getSelectedItem().toString().equals("Seleccione..."))  || (cmbCarrera.getSelectedItem().toString().equals("Seleccione..."))  || (cmbTipoProyecto.getSelectedItem().toString().equals("Seleccione..."))  ||     (txtCedulaP.getText().equals("")) || (txtNombre.getText().equals("")) || (txtNombrTut.getText().equals("")) || (txtApeTut.getText().equals("")) || (txtCedTut.getText().equals("")) || (txtTlfTut.getText().equals(""))     )  {
            ...
            Mensaje.showMessageDialog(this,"Fecha de inicio inválida","Error",Mensaje.ERROR_MESSAGE);
        }
        else if (tblProfesor.getRowCount()==0){

            Mensaje.showMessageDialog(this,"El proyecto no tiene tutor académico inscrito","Error",Mensaje.ERROR_MESSAGE);
            ...
            consulta="INSERT into proyecto (ncuo,nombre,cedtutoracademico,cedtutorcomunitario,estado,carrera,tipo,fechainicio,fechafin) values('"+cmbCuo.getSelectedItem().toString()+"','"+txtNombre.getText().toUpperCase()+"','"+txtCedulaP.getText()+"','"+cmbCedTut.getSelectedItem().toString()+txtCedTut.getText()+"','ESPERA','"+cmbCarrera.getSelectedItem().toString()+"','"+cmbTipoProyecto.getSelectedItem().toString().toUpperCase()+"','"+obtenerfecha()+"','POR DEFINIR')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NuevoProyecto2().setVisible(true);
            }
        });
    }
