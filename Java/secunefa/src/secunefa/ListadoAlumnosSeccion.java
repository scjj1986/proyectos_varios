...
public class ListadoAlumnosSeccion extends javax.swing.JFrame {
    String carrera,codigomateria,seccion;
    DefaultTableModel modelo;

    /**
     * Creates new form ListadoAlumnosSeccion
     */
    ...
    private void initComponents() {
        ...
        setTitle("LIstado Alumnos Sección");
        setResizable(false);
        ...
        jLabel1.setText("LISTADO DE ALUMNOS POR SECCIÓN");
            ...
            if (li.existearchivo("inscritos.obj"))
            {
                ...
                while (aux!=null)
                {
                    ...
                    while (aux2!=null)
                    {
                        ...
                        if ((aux.codigomateria.equals(codigomateria))&& (aux.seccion.equals(ComboSeccion.getSelectedItem().toString())) && (aux2.cedula.equals(aux.cedulaalumno)))
                        {
                                datos[0]=aux2.cedula;
                                datos[1]=aux2.nombre;
