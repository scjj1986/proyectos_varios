 ...
 * @author salazar
 */
public class ListadoAlumnosAplazados extends javax.swing.JFrame {
    DefaultTableModel modelo;
    String codigomateria;
    public ListadoAlumnosAplazados() {
        initComponents();
        setSize(624,569);
        setResizable(false);
    ...
    private void initComponents() {
        ...
        setTitle("Listado Alumnos Aplazados");
        ...
        jLabel1.setText("LISTADO DE ALUMNOS APLAZADOS");
                ...
                if (li.existearchivo("inscritos.obj"))
                {
                    ...
                    while (aux!=null)
                    {
                        ...
                        while (aux2!=null)
                        {
                            ...
                            if ((aux.codigomateria.equals(codigomateria))&& (aux.seccion.equals(ComboSeccion.getSelectedItem().toString())) && (aux2.cedula.equals(aux.cedulaalumno)) && (aux.nota<10))
                            {
                                datos[0]=aux2.cedula;
                                datos[1]=aux2.nombre;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoAlumnosAplazados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoAlumnosAplazados().setVisible(true);
            }
        });
    }
