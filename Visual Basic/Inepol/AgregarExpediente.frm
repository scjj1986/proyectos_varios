...
Private Sub btnGuardar_Click()
    ...
    Else
        ...
        If Not Registros.EOF And Not Registros.BOF Then
            MsgBox ("El número OCAP ingresado coincide con el de un expediente registrado en la base de datos.")
        ...
        Else
            ...
            MsgBox ("Datos almacenados exitosamente. Código del nuevo expediente: " & codig)
